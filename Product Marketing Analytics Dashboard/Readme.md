...
This project presents a visual analytics dashboard built to evaluate marketing performance across products, regions, channels, and time. It is designed to help stakeholders understand the effectiveness of marketing spend, identify high-return areas, and support better decision-making.
...
It is useful for digital marketers, business analysts, and decision-makers without requiring prior domain knowledge.
...
The dashboard highlights several important marketing metrics:
...
These KPIs give a snapshot of campaign health and efficiency.
...
No prior analytics knowledge is required — visuals are self-explanatory.
...
All values are aggregate representations of marketing performance.
